...
export function coolingtowerfan(pen: TopologyPen) {
...
let value = 0;
   for (let i = 0; i < 4; i++) {
       fanblade(pen,value+ Math.PI / 2 * i, myw, myh, x, y);
   }
   fanheart(pen);
...
//扇叶
function fanblade( pen: TopologyPen, rote: any, myw: any, myh: any, x: any, y: any) {
...
//扇心
function fanheart( pen: TopologyPen) {
