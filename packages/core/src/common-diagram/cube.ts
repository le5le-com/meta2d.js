...
export function cube(pen: Pen) {
  ...
  path.lineTo(
    pen.calculative.worldRect.x + pen.calculative.worldIconRect.width - offset,
    pen.calculative.worldRect.y + offset
  );
  path.moveTo(
    pen.calculative.worldRect.x + pen.calculative.worldIconRect.width,
    pen.calculative.worldRect.y + pen.calculative.worldIconRect.height - offset
  );
  path.lineTo(
    pen.calculative.worldRect.x + pen.calculative.worldIconRect.width - offset,
    pen.calculative.worldRect.y + pen.calculative.worldIconRect.height
  );
  path.moveTo(
    pen.calculative.worldRect.x + offset,
    pen.calculative.worldRect.y + pen.calculative.worldIconRect.height - offset
