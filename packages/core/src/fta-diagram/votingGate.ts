...
//   path.fillStyle = '#333333';
//   path.font = myh + 'px Arial';
//   path.textBaseline = 'bottom';
//   path.textAlign = 'center';
//   path.fillText('o', x + myw, y + pen.calculative.worldRect.height);
...
//   path.textBaseline = 'bottom';
//   path.textAlign = 'center';
//   path.fillText('m', x + (myw * 2) / 5, y + pen.calculative.worldRect.height);
...
//   path.textBaseline = 'bottom';
//   path.textAlign = 'center';
//   path.fillText('o', x + (myw * 8) / 5, y + pen.calculative.worldRect.height);
//   path.closePath();
