...
function drawSin(path: Path2D, pen: any) {
  ...
  path.arc(
    pen.calculative.worldRect.x + width / 2,
    pen.calculative.worldRect.y + height / 2,
    R / 2,
    -absAngle,
    Math.PI + absAngle
  );
  ...
  for (let x = leftx; x < rightx; x += 20 / (rightx - leftx)) {
    const y = waveHeight * Math.sin((leftx + x) * waveWidth + xOffset) + pen.calculative.worldRect.y + R / 2 - yOffset;
  ...
  if (minValue && maxValue) {
    if (minX > maxX) {
      ...
      if (width >= height) {
        ...
        ctx.lineTo(minX - scaleLineWidth - deltaX, y + ((100 - minValue) / 100) * canvasHeight);
        ctx.direction = 'rtl';
        ctx.fillText(pen.data.minText, minX - scaleLineWidth - deltaX, y + ((100 - minValue) / 100) * canvasHeight + 3);
        ctx.fillText(minValue, minX - scaleLineWidth - deltaX, y + ((100 - minValue) / 100) * canvasHeight + fontSize);

        ctx.moveTo(maxX, y + ((100 - maxValue) / 100) * canvasHeight);
        ctx.lineTo(maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight);
        ctx.direction = 'rtl';
        ctx.fillText(pen.data.maxText, maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight + 3);
        ctx.fillText(maxValue, maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight + fontSize);
      } else {
        ctx.moveTo(minX, y + ((100 - minValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.lineTo(minX - scaleLineWidth - deltaX, y + ((100 - minValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.direction = 'rtl';
        ctx.fillText(
          pen.data.minText,
        ...
        ctx.moveTo(maxX, y + ((100 - maxValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.lineTo(maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.direction = 'rtl';
        ctx.fillText(
          pen.data.maxText,
          maxX - scaleLineWidth,
      ...
      if (width >= height) {
        ctx.moveTo(minX, y + ((100 - minValue) / 100) * canvasHeight);
        ctx.lineTo(minX - scaleLineWidth, y + ((100 - minValue) / 100) * canvasHeight);
        ctx.direction = 'rtl';
        ctx.fillText(pen.data.minText, minX - scaleLineWidth, y + ((100 - minValue) / 100) * canvasHeight + 3);
        ctx.fillText(minValue, minX - scaleLineWidth, y + ((100 - minValue) / 100) * canvasHeight + 15);

        ctx.moveTo(maxX, y + ((100 - maxValue) / 100) * canvasHeight);
        ctx.lineTo(maxX - scaleLineWidth - deltaX, y + ((100 - maxValue) / 100) * canvasHeight);
        ctx.direction = 'rtl';
        ctx.fillText(pen.data.maxText, maxX - scaleLineWidth - deltaX, y + ((100 - maxValue) / 100) * canvasHeight + 3);
        ctx.fillText(maxValue, maxX - scaleLineWidth - deltaX, y + ((100 - maxValue) / 100) * canvasHeight + 15);
      } else {
        ctx.moveTo(minX, y + ((100 - minValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.lineTo(minX - scaleLineWidth, y + ((100 - minValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.direction = 'rtl';
        ctx.fillText(
          pen.data.minText,
          minX - scaleLineWidth,
        ...
        ctx.moveTo(maxX, y + ((100 - maxValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.lineTo(maxX - scaleLineWidth - deltaX, y + ((100 - maxValue) / 100) * canvasHeight + lR / 2 - R / 2);
        ctx.direction = 'rtl';
        ctx.fillText(
          pen.data.maxText,
    ...
    if (width >= height) {
      ...
      ctx.direction = 'rtl';
      ctx.fillText(pen.data.maxText, maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight + 3);
      ctx.fillText(maxValue, maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight + 15);
    } else {
      ctx.moveTo(maxX, y + ((100 - maxValue) / 100) * canvasHeight + lR / 2 - R / 2);
      ctx.lineTo(maxX - scaleLineWidth, y + ((100 - maxValue) / 100) * canvasHeight + lR / 2 - R / 2);
      ctx.direction = 'rtl';
